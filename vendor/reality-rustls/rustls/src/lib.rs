...
pub mod client {
    ...
    pub use client_conn::{
        ClientConfig, ClientConnectionData, ClientHelloFingerprint, ClientSessionStore,
        EarlyDataError, ResolvesClientCert, Resumption, Tls12Resumption, UnbufferedClientConnection,
    };
    #[cfg(feature = "std")]
